...
def extractWeights(args):
    ...
    backbone_hparams = {"backbone_model": model_ckpt_hparams["backbone_model"],
                        ...
                        "pretrained_backbone_rgb": model_ckpt_hparams["baseline_model_path"],
                        "pretrained_backbone_opti": model_ckpt_hparams["optical_model_path"]                        
                        }
    ...
    opti_dict_pytorch = get_dict("opti")
    ...
    tmp_dict_pytorch = {"rgb_state_dict_backbone": rgb_dict_pytorch["state_dict_backbone"],
                        ...
                        "opti_state_dict_backbone": opti_dict_pytorch["state_dict_backbone"],
                        "opti_state_dict_head": opti_dict_pytorch["state_dict_head"],
                        "opti_state_dict_backbone_ema": opti_dict_pytorch["state_dict_backbone_ema"],
                        "opti_state_dict_head_ema": opti_dict_pytorch["state_dict_head_ema"],
    ...
    filename = os.path.join(output_dir, args['model_name']) + ".ckpt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='/home/aredwann/PyDev/SewerML-tracker/results/joint_vit/SewerMLJoint_resnet50_MultiScaleViTHead_FNetBlock_Sinkhorn/version_21')
