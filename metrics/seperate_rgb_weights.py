...
def extractWeights(args):
    ...
    backbone_hparams = {"backbone_model": model_ckpt_hparams["backbone_model"],
                        ...
                        "pretrained_backbone": model_ckpt_hparams["baseline_model_path"],
    ...
    rgb_dict_pytorch["hyper_parameters_backbone"] = backbone_hparams
    rgb_dict_pytorch["hyper_parameters_head"] = head_hparams
    ...
    # filename = os.path.join(output_dir, args['model_name'] + "_RGB_" + os.path.basename(args['model_path'])) + ".ckpt"
    filename = os.path.join(output_dir, args['model_name']) + ".ckpt"
    torch.save(rgb_dict_pytorch, filename)
    print(new_dir)


if __name__ == "__main__":
    parser = ArgumentParser()
    parser.add_argument("--model_path", type=str, default='/home/aredwann/PyDev/SewerML-tracker/results/joint_vit/SewerMLJoint_resnet50_MultiScaleViTHead_FNetBlock_Sinkhorn/version_32')
