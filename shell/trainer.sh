...
# pretrained weights
RGB_WEIGHTS="/home/aredwann/MSHViT/weights/resnet50_hvit_sinkhorn.ckpt"
OPTI_WEIGHTS="/home/aredwann/MSHViT/results/opticalflow_full/resent50_msvit_opticalflow.ckpt"
...
TRAIN_PY="/home/aredwann/PyDev/SewerML-tracker/ensemble_trainer.py"

CUDA_VISIBLE_DEVICES=1 $PYTHON $TRAIN_PY \
        --precision 16 \
        ...
        --head_model $HEAD_NET \
        --baseline_model_path $RGB_WEIGHTS \
        --optical_model_path $OPTI_WEIGHTS \
        --token_dim $TOKEN_DIM \
        --transformer_depth 2 \
        --block_drop 0. \
